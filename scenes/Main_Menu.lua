...
function scene:create( event )
    ...
    exitButton:setFillColor(0,0,0,0);
    ...
    lore:addEventListener("tap", function()
        composer.gotoScene("scenes.lore", {effect = "fade", time = 250});
    end);
